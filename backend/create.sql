create table tb_sales (id bigint not null auto_increment, amount double precision, date date, deals integer, visited integer, seller_id bigint, primary key (id)) engine=MyISAM;
create table tb_sellers (id bigint not null auto_increment, name varchar(255), primary key (id)) engine=MyISAM;
